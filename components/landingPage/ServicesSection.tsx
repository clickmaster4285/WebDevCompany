...
const SERVICES = [
  {
    ...
    img: devImg,
    desc: "Full-stack engineering with React, TypeScript and edge runtimes — built for scale.",
  ...
  },
  {
    ...
    title: "UI / UX Design",
    img: designImg,
    desc: "Interface systems that balance editorial beauty with frictionless usability.",
  ...
  },
  {
    ...
    img: saasImg,
    desc: "Bespoke SaaS dashboards, internal tools and AI-enabled product surfaces.",
    metric: ["6w", "Avg. MVP"],
  },
  {
    n: "04",
    title: "E-Commerce",
    img: ecomImg,
    desc: "High-conversion storefronts with headless commerce architecture.",
    metric: ["3.2×", "AOV lift"],
  },
  {
    n: "05",
    title: "Performance",
    img: corpImg,
    desc: "Core Web Vitals, edge caching and rendering pipelines tuned to perfection.",
    metric: ["<200ms", "TTFB"],
  },
  {
    n: "06",
    ...
    img: motionImg,
    desc: "WebGL scenes, GSAP timelines and physics-based interactions.",
    metric: ["60fps", "Always"],
  },
];
          ...
          >
            ...
            <div className="relative z-10 flex w-full flex-col justify-between p-8 md:p-14">
              <div className="flex items-start justify-between">
                <span className="text-xs uppercase tracking-[0.3em] text-violet-soft">
                  {s.n}
                </span>
                <span className="text-xs uppercase tracking-[0.3em] text-ink-mute">
                  Service
                </span>
              </div>
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-6 max-w-lg text-base text-ink-soft md:text-lg">
                  {s.desc}
                </p>

                <div className="mt-10 flex items-center gap-10">
                  <div>
                    <div className="text-display text-3xl text-violet-soft md:text-4xl">
                      {s.metric[0]}
                    </div>
                    <div className="mt-1 text-xs uppercase tracking-widest text-ink-mute">
                      {s.metric[1]}
                    </div>
                  </div>

                  <a
                    className="inline-flex items-center gap-2 text-sm text-ink hover:text-violet-soft"
                    href="#contact"
                  >
