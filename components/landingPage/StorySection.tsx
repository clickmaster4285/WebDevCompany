        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 md:col-span-5">
            ...
            <h2 className="text-display text-[clamp(2.2rem,5vw,4.4rem)] text-ink">
              ...
              <br />
              <span className="overflow-hidden inline-block">
                <span className="story-line inline-block text-ink-mute">
                  Code as
                </span>
              </span>{" "}
              <span className="overflow-hidden inline-block">
            ...
            <div className="mt-10 grid grid-cols-2 gap-6 max-w-md">
              {[
                ...
                <div key={h}>
                  <div className="text-xs uppercase tracking-widest text-violet-soft">
                    {h}
                  </div>
          ...
          <div className="col-span-12 md:col-span-7">
            ...
            >
              <div ref={img} className="relative w-full h-full">
                <Image
                  src={storyImg}
