...
const ITEMS = [
  {
    quote:
      "ClickMasters didn't just redesign our product — they reshaped how our team thinks about craft. Every detail compounds.",
    name: "Helena Marsh",
  ...
  {
    quote:
      "The most senior engineering partner we've ever worked with. Cinematic motion, real engineering, real results.",
    name: "Daniel Vogt",
      ...
      <div className="mt-20 space-y-32">
        {ITEMS.map((t, i) => (
          ...
          >
            ...
            >
              <div className="t-img relative w-full h-full">
                <Image
                  src={t.portrait}
                  alt={t.name}
                  fill
