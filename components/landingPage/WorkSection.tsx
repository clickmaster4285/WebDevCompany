...
const PROJECTS = [
  {
    ...
    img: saasImg,
    desc:
      "A modern restaurant website featuring online reservations, digital menus, event bookings, and a premium dining experience.",
  ...
  },
  {
    ...
    img: fintechImg,
    desc:
      "A modern dental clinic website with online appointment booking, treatment pages, and patient resources.",
  ...
  },
  {
    ...
    img: ecomImg,
    desc:
      "A property showcase platform featuring advanced search, interactive maps, and agent profiles.",
  ...
  },
  {
    ...
    img: corpImg,
    desc:
      "A scalable online store with custom product experiences, fast checkout, and optimized conversions.",
    ...
    <section ref={root} id="work" className="relative py-24">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        <h2 className="text-display text-[clamp(2rem,5vw,4rem)] text-ink max-w-3xl">
          Recent products we've shaped, shipped{" "}
          <span className="text-violet-soft">and scaled.</span>
        </h2>
      </div>
              ...
              <div className="flex flex-col justify-between p-8 md:p-14">
                ...
                <div className="mt-10 flex flex-wrap items-end justify-between gap-6">
                  ...
                  <div className="text-right">
                    <div className="text-display text-2xl text-violet-soft">
                      {p.result}
                    </div>
